...
const EngineeringChristmasTree = () => {

  const containerStyle = {
    backgroundImage: 'url("./EngineeringChristmasTreeBg.png")', // замените на нужный путь
      ...
      <section className={s.products} style={containerStyle}>
        ...
        <div className="container">
          <div className={s.wrap}>
            <h1 className={s.title}>Инженерная ёлка</h1>
...
export default EngineeringChristmasTree